...
public class BrokerCreditTest {
    ...
    void setupOrderBook() {
        ...
        broker1 = Broker.builder().credit(1_000_000L).build();
        broker2 = Broker.builder().credit(1_000_000L).build();
    ...
    void new_sell_order_matches_completely_with_part_of_the_first_buy() {
        ...
        assertThat(result.remainder().getBroker().getCredit()).isEqualTo(1_157_000L);
